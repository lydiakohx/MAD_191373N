...
class Details4 extends StatelessWidget {
  ...
  Image _buildJournalHeaderImage(){
    return Image(image: AssetImage('images/Toast.jpg'),
    fit: BoxFit.cover,
    );
  }
  ...
  Row _buildJournalFooterImages(){
    return Row(
      ...
      children: <Widget>[CircleAvatar(backgroundImage: AssetImage('images/Toast1.jpg'),
      radius: 40.0,
      ),
      CircleAvatar(backgroundImage: AssetImage('images/Toast2.jpg'),
       radius: 40.0,
      ),
      CircleAvatar(backgroundImage: AssetImage('images/Toast3.jpg'),
       radius: 40.0,
      ),
      SizedBox(
        width:100.0,
