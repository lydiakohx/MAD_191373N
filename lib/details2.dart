...
class Details2 extends StatelessWidget {
  ...
  Image _buildJournalHeaderImage(){
    return Image(image: AssetImage('images/Chicken.jpg'),
    fit: BoxFit.cover,
    );
  }
  ...
  Row _buildJournalFooterImages(){
    return Row(
      ...
      children: <Widget>[CircleAvatar(backgroundImage: AssetImage('images/Chicken1.jpg'),
      radius: 40.0,
      ),
      CircleAvatar(backgroundImage: AssetImage('images/Chicken2.jpg'),
       radius: 40.0,
      ),
      CircleAvatar(backgroundImage: AssetImage('images/Chicken3.jpg'),
       radius: 40.0,
      ),
      SizedBox(
        width:100.0,
