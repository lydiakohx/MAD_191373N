...
class Details3 extends StatelessWidget {
  ...
  Image _buildJournalHeaderImage(){
    return Image(image: AssetImage('images/Salad.jpg'),
    fit: BoxFit.cover,
    );
  }
  ...
  Row _buildJournalFooterImages(){
    return Row(
      ...
      children: <Widget>[CircleAvatar(backgroundImage: AssetImage('images/Salad1.jpg'),
      radius: 40.0,
      ),
      CircleAvatar(backgroundImage: AssetImage('images/Salad2.jpg'),
       radius: 40.0,
      ),
      CircleAvatar(backgroundImage: AssetImage('images/Salad3.jpg'),
       radius: 40.0,
      ),
      SizedBox(
        width:100.0,
